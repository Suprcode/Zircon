...
namespace Shared.Rendering.SharpDXD3D9
{
    public static class SharpDXD3D9Manager
    {
        ...
        public static void Create()
        {
            ...
            try
            {
                _parameters = new PresentParameters
                {
                    ...
                    PresentationInterval = RenderingPipelineManager.HostSettings.VSync ? PresentInterval.Default : PresentInterval.Immediate,
                    PresentFlags = PresentFlags.LockableBackBuffer,
                    DeviceWindowHandle = RenderingPipelineManager.RenderTarget.Handle,
                ...
                Device = new Device(_direct3D, adapterIndex, DeviceType.Hardware, RenderingPipelineManager.RenderTarget.Handle, CreateFlags.HardwareVertexProcessing | CreateFlags.Multithreaded | CreateFlags.FpuPreserve, _parameters);
        ...
        public static void ResetDevice()
        {
            ...
            if (RenderingPipelineManager.RenderTarget.ClientSize.Width == 0 || RenderingPipelineManager.RenderTarget.ClientSize.Height == 0)
            {
                return;
            }
            ...
            parameters.PresentationInterval = RenderingPipelineManager.HostSettings.VSync ? PresentInterval.Default : PresentInterval.Immediate;
        ...
        public static void SetGameWindowToMonitor(int monitorIndex)
        {
            ...
            if (RenderingPipelineManager.HostSettings.FullScreen)
            {
                RenderingPipelineManager.RenderTarget.Bounds = RenderingPipelineManager.GetMonitorDisplayBounds(targetScreen);
        ...
        {
            if (RenderingPipelineManager.RenderTarget == null) return;
            ...
            if (RenderingPipelineManager.HostSettings.FullScreen && _adapterIndex != GetSelectedAdapterIndex())
            {
                Create();
        ...
        public static void SetResolution(Size size)
        {
            ...
            if (RenderingPipelineManager.RenderTarget is Form renderForm)
        ...
        private static void ApplyWindowBounds()
        {
            ...
            if (RenderingPipelineManager.HostSettings.FullScreen)
            {
                ...
                if (RenderingPipelineManager.HostSettings.FullScreen && _displayMode.Apply(selectedScreen, RenderingPipelineManager.HostSettings.GameSize))
                {
                    ...
                    RenderingPipelineManager.RenderTarget.Bounds = RenderingPipelineManager.GetMonitorDisplayBounds(deviceName, selectedScreen.Bounds);
                    return;
                }

                _displayMode.Restore();
                RenderingPipelineManager.RenderTarget.Bounds = RenderingPipelineManager.GetMonitorDisplayBounds(selectedScreen);
                return;
            }
        ...
        {
            if (RenderingPipelineManager.HostSettings.FullScreen)
                return RenderingPipelineManager.HostSettings.GameSize;

            Size size = RenderingPipelineManager.RenderTarget.ClientSize;
        ...
        private static bool ShouldUseWindowedPresentation()
        {
            ...
            return _displayMode.IsActive(RenderingPipelineManager.GetSelectedScreen(), RenderingPipelineManager.HostSettings.GameSize);
        }
        ...
        private static void CenterWindowOnScreen(Screen screen)
        {
            ...
            int x = bounds.X + (bounds.Width - renderForm.Width) / 2;
            int y = bounds.Y + (bounds.Height - renderForm.Height) / 2;

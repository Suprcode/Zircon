...
namespace Shared.Rendering.SharpDXD3D11
{
    public sealed class SharpDXD3D11SpriteRenderer : IDisposable
    {
        ...
        private void InitializeSampler()
        {
            ...
            _pointSamplerState = new SamplerState(_device, description);

            description.Filter = Filter.MinMagMipLinear;
            _linearSamplerState = new SamplerState(_device, description);
        }

        private SamplerState GetSamplerState()
        {
            return SharpDXD3D11Manager.InterpolationMode == SharpDX.Direct2D1.BitmapInterpolationMode.Linear
                ? _linearSamplerState
                : _pointSamplerState;
        }
        ...
        private void DrawBatch(IReadOnlyList<Texture2D> textures, Size targetSize, IReadOnlyList<SpriteBatchItem> sprites, BlendMode blendMode, float blendRate, PixelShader pixelShader)
        {
            ...
            _context.PixelShader.SetSampler(0, GetSamplerState());

...
namespace Client.Controls
{
    public sealed class DXConfigWindow : DXWindow
    {
        ...
        private DXCheckBox ItemNameCheckBox, MonsterNameCheckBox, PlayerNameCheckBox, UserHealthCheckBox, MonsterHealthCheckBox, DamageNumbersCheckBox, 
            ...
            DrawParticlesCheckBox, DrawWeatherCheckBox, SmoothRenderingBox;
        ...
        public DXConfigWindow()
        {
            ...
            {
                Label = { Text = CEnvir.Language.CommonControlConfigWindowGraphicsTabSmoothRendering },
                Parent = GraphicsTab,
            };
            SmoothRenderingBox.Location = new Point(120 - SmoothRenderingBox.Size.Width, 120);

...
{
    [MagicType(MagicType.HeavenlySky)]
    public class HeavenlySky : MagicObject
    {
        protected override Element Element => Element.Lightning;

        public HeavenlySky(PlayerObject player, UserMagic magic) : base(player, magic)
        {
        ...
        public override MagicCast MagicCast(MapObject target, Point location, MirDirection direction)
        {
            ...
            var delay = SEnvir.Now.AddMilliseconds(1000);

...
{
    [MagicType(MagicType.SummonJinSkeleton)]
    public class SummonJinSkeleton : MagicObject
    {
        protected override Element Element => Element.None;
        public override bool UpdateCombatTime => false;

        public SummonJinSkeleton(PlayerObject player, UserMagic magic) : base(player, magic)
        {

...
{
    [MagicType(MagicType.BloodLust)]
    public class BloodLust : MagicObject
    {
        protected override Element Element => Element.None;
        public override bool UpdateCombatTime => false;

        public BloodLust(PlayerObject player, UserMagic magic) : base(player, magic)
        {
        ...
        public override void MagicComplete(params object[] data)
        {
            ...
            for (int i = cell.Objects.Count - 1; i >= 0; i--)
            {
                ...
                ob.BuffAdd(BuffType.BloodLust, TimeSpan.FromSeconds((Magic.GetPower() + Player.GetSC() * 2)), buffStats, true, false, TimeSpan.Zero);
